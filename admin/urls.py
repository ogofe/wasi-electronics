...
urlpatterns = [
    ...
    path('projects/', products_list_view, name="projects"),
    path('projects/add/', product_create_view, name="add-project"),
    path('projects/<pk>/change/', product_edit_view, name="edit-project"),
